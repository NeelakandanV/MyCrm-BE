...
export const VerifyUserLink = async(req,res)=>{
    try{
        ...
        if(!find_User){
            ...
            const link = `https://mycrmportal.netlify.app/verifyUser/${find_User._id}/${ResetString}/${token}`
...
export const ForgotPassword = async(req,res)=>{
    try{
        ...
        if(!find_User){
            ...
            const link = `https://mycrmportal.netlify.app/ResetPassword/${find_User._id}/${ResetString}/${token}`
            // for Sending mails - nodemailer
            var transporter = nodemailer.createTransport({
                service: 'gmail',
                auth: {
...
export const Leads_ForgotPassword = async(req,res)=>{
    try{
        ...
        if(!find_Lead){
            ...
            const link = `https://mycrmportal.netlify.app/Lead/ResetPassword/${find_Lead._id}/${ResetString}/${token}`
            // for Sending mails - nodemailer
            var transporter = nodemailer.createTransport({
                service: 'gmail',
                auth: {
